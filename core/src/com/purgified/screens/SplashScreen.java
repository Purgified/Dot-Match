...
// Splash screen class that gets called when user launches the app. Displays logo for a few seconds
public class SplashScreen implements Screen {
	...
	public SplashScreen(DotMatch game, AdsController adsController) {
		this.game = game;
